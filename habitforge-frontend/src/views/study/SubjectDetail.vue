  ...
  <div>
    ...
    <div class="page-body split is-rail">
      <div class="col-main">
        ...
        <!-- 章节树 -->
        <div class="section-title">{{ isDesktop ? '章节目录' : '📖 章节目录' }}</div>
      ...
      <div class="col-side">
        ...
        <div class="section-title">{{ isDesktop ? '学习工具' : '🧰 学习工具' }}</div>
        <van-cell-group inset class="tools-group">
          <van-cell
            :title="isDesktop ? '闪卡复习' : '🃏 闪卡复习'"
